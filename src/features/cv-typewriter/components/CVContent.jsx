...
const CVContent = forwardRef(function CVContent(
    ...
    return (
        <div ref={ref} className="cv-content-inner">
            {(!paged || pageIndex === 0) && (
                <div className="text-center" data-block="header" data-block-id="header" data-section="header">
                ...
                <div className="paged-content">
                    {blocks.map((block, i) => {
                            ...
                            return (
                                ...
                                >
                                    <ul className="list-disc pl-5">
                                        <li className="text-[13px] leading-[1.25] text-foreground/80">{block.content}</li>
                                    </ul>
                                </div>
                            );
                        }
                        ...
                        if (block.type === "tech-item") {
                            return (
                                ...
                                >
                                    ...
                                    <div className="text-[13px] leading-[1.25] text-foreground/90">{block.item.details}</div>
                                </div>
                            );
                        }
                        ...
                        if (block.type === "tech-group") {
                            return (
                                <div key={blockId} data-block-id={blockId} className="space-y-[var(--cv-list-gap)] text-left">
